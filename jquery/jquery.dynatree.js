...
DynaTreeNode.prototype = {
	...
	_getInnerHtml: function() {
        ...
        if( !data.isFolder && opts.checkbox && data.hideCheckbox == true && !data.isStatusNode) {
			res += cache.tagCheckboxHidden;
...
//		_log("warn", "jQuery.support.boxModel " + jQuery.support.boxModel);
		...
		this.cache = {
            ...
            tagCheckboxHidden: "<span class='" + opts.classNames.checkboxHidden + "'><img src='/images/checkbox_disabled.png' /></span>",
			lastentry: undefined
		};
...
//		}
		...
		case "helper":
			...
			var helper = $("<div class='dynatree-drag-helper'><span class='dynatree-drag-helper-img' /></div>")
				//.append($(event.target).closest('a').clone());  //mike - old - takes node title
...
*/
	...
	bind: function() {
		...
		var eventNames = "click.dynatree dblclick.dynatree mousedown.dynatree";
		...
		this.element.bind(eventNames, function(event){
			...
			try {
				switch(event.type) {
                case "mousedown":
					return ( o.onMouseDown && o.onMouseDown.call(tree, dtnode, event)===false ) ? false : dtnode._onMouseDown(event);
				case "click":
...
$.ui.dynatree.prototype.options = {
    ...
    onMouseDown: null, // null: generate focus, expand, activate, select events.
...
//		document: "dynatree-document",
        ...
        checkboxHidden: "dynatree-checkbox-hidden",
