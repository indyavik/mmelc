    ...
    $.extend(PxlViewer.Menu.prototype, {
        ...
        inject: function() {
            if (typeof this.html == 'undefined') {
                ...
                this.html += this._createlinkButton("pathXLMenuHomeLink", null, "/");
                ...
                if (this.options.showZoomControl) {
                    ...
                    contents += this._createButton("mag83", "setMag", "<span>x83</span>");
            ...
            $('.setMag').mouseup(function () {
                ...
                switch ($(this).get(0).id) {
                    ...
                    case "mag40":
                        ...
                        break;
                    case "mag83":
                        pThis.base.viewer.viewport.zoomTo(pThis.base.viewer.viewport.imageToViewportZoom(83 / currMag), center, false);
                        magTxt = "x83";
                        break;
                }
