...
function get_next_page(current_page, signal){
  ...
  console.log('next page current module -->' + current_unit)
    ...
    if (current_index == -1) { 
      ...
      alert('page not found'); return false; 
...
/*
  ...
  if ( module  == '8' && sessionStorage.getItem('certification_user_logged_in') == null){
...
function getSingleReportScoreAndFeedback(userReport,reportName) {
	...
	if (userReportBinary.substring(0,1)=='1') { //MPS
		...
		if (Pf!='000') {
			...
			Pfe = 1;
			switch(Pf) {
				case '100':	parasiteText = parasiteText + 'trophozoites seen. '; break;
				case '010': parasiteText = parasiteText + 'schizonts seen. '; break;
				case '001':	parasiteText = parasiteText + 'gametocytes seen. '; break;
				case '110': parasiteText = parasiteText + 'trophozoites and schizonts seen. '; break;
				case '101':	parasiteText = parasiteText + 'trophozoites and gametocytes seen. '; break;
				case '011': parasiteText = parasiteText + 'schizonts and gametocytes seen. '; break;
				case '111':	parasiteText = parasiteText + 'trophozoites, schizonts, and gametocytes seen. '; break;
			}
		}
